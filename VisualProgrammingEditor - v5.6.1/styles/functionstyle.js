  ...
  function operationBox(functionName, shapeColor) {
    if(functionName == "OPERATION") {
      return $(go.Shape,"Circle", { width: 50, height: 50, fill: yellowgrad});
    }
    return $(go.Shape, nodeFunctionShapeStyle(),{ figure: "Rectangle", fill: shapeColor })
  }

  function functionStyle(shapeColor, functionName) {
    return [
      selectionStyle(),
      operationBox(functionName, shapeColor),
