var paletteComps = [  // specify the contents of the Palette
            ...
            {key: 24, type: "returnGroup", isGroup: true},
            {key: 25, type: "return", group: 24},
            {key: 26, type: "args", arity: { "from" : 1 , "to": 1},  items: [ 
              {portId: "val"}
            ], group: 24},

            { key: 27, type: "blocks", items: [ {portId: "1", isport: true}, {portId: "2", isport: true} ]}
        ]
    ...
    var paletteLinks = [
            ...
            { category: "Reversed", from: 25, to: 26}
        ]